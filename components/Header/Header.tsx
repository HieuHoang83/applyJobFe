...
const Header = () => {
    ...
    return (
        ...
        <div className='flex flex-row items-center justify-center w-[100%] bg-custom h-[480px]'>
            <div className='m-6 flex flex-col w-[35%]'>
                <p className=' flex-1 text-[1.25rem] font-semibold text-white'>Công nghệ AI dự đoán, cá nhân hóa việc làm</p>
                <h2 className='flex-1 text-[26px] font-semibold  text-white '>
            ...
            <div className='m-6 w-[35%]'>
                <p className='text-[1.25rem] font-semibold text-white'>Công nghệ AI dự đoán, cá nhân hóa việc làm</p>
